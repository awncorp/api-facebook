# Facebook Client Super Class
package API::Facebook::Client;

use API::Facebook::Class;
use API::Facebook::Exception;
...
has url => (
    ...
    default  => fun { Mojo::URL->new("https://graph.facebook.com") },
);
